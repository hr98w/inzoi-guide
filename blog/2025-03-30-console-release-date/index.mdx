...
authors: []
tags: ['Console', 'PlayStation 5', 'Xbox Series X|S', 'Release Date', 'Download']
---
...
### Is inZOI on Xbox?
Not yet. inZOI will be released on Xbox Series X|S in Q4 2025 or later, after the PC Early Access period. The game will not be available on Xbox One.

### Will inZOI be on PS5?
Yes, inZOI is planned for release on PS5 in Q4 2025 or later. The console version will include all features from the PC version and will be optimized specifically for PlayStation 5.

### Can you play inZOI on Mac?
No, inZOI is currently only available on Windows PC through Steam Early Access. There are no announced plans for a Mac version at this time.
...
### Is inzoi coming to console?
Yes, this is planned on Q4, 2025.
